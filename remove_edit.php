...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/img_bg_2.jpg)">
      ...
      <?php
			...
			$result1= mysqli_query($connection,"SELECT `qstn_id`,`qstn` FROM `questions`");
			...
			";
					    ...
					    while($array=mysqli_fetch_array($result1))
			    {
						...
						<div style='overflow-x:auto;'><tr><td>";
				  			    echo $array['qstn_id']."<br/></td><td>";
			    echo $array['qstn']."<br/>";
			  echo "<td><a href='removeq.php?id=".$array['qstn_id']."&name=".$array['qstn']."'>
				<button class='btn danger' onclick='myFunction()'>Remove</button></a></td>";
 echo "<td><a href='edit_qstn.php?id=".$array['qstn_id']."&name=".$array['qstn']."'>

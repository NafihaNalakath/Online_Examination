										...
										<form class="form-inline" method="POST">
											<div class="col-md-6 col-sm-6">
												<div class="form-group">
													...
													Edit your question<input type="text" class="form-control" name="question">
												</div>
											</div>
											</div>
										</div>';
...
';
				$q1=mysqli_query($connection,"SELECT `answers`,`correct_answer` FROM
				  `answers` WHERE qstnid='$q3'");
											$i=1;
				  while($q2=mysqli_fetch_array($q1))
					{
						$q4=$q2['answers'];
						echo'<input type="radio" name="canswr" value="'.$i.'">    ';
				  echo'<input type="text" value="'.$q4.'" name="answer'.$i.'"><br><br> ';
				  $i++;
				}

							...
							<ul>
								...
								<li class="has-dropdown">
									...
									<ul class="dropdown">
										...
										<li><a href="add_instruction.php">Add insructions</a></li>
										<li><a href="remove_edit_instruction.php">Remove/Edit insructions</a></li>
									</ul>
								</li>
								<li class="has-dropdown">
								<a href="#">Type</a>
      				...
      				<div class="col-md-8 col-md-offset-">
      					<form class="form-inline"  method="POST" action="add_instruction.php">
      						<div class="col-md-9 col-sm-3">
      							...
      							Enter the instruction to the exam
                    	<input type="textarea" class="form-control" name="instruction" placeholder="instruction">
      							</div>
      						</div>

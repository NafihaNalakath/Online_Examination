	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/img_bg_2.jpg)">
      ...
      <?php
			...
			<td>EDIT</td></tr>";
      			    ...
      			    echo $array['id']."<br/></td><td>";
      			    echo $array['instruction']."<br/>";
      			    echo "<td><a href='remove_instruction.php?id=".$array['id']."&name=".$array['instruction']."'>
      				<button class='btn danger' onclick='myFunction()'>Remove</button></a></td>
							";
               echo "<td><a href='edit_instruction.php?id=".$array['id']."&name=".$array['instruction']."'>
